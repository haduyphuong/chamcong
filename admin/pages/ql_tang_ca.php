                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "
                                    SELECT nv.Ma_nv, nv.username, tc.Gio_bat_dau, tc.Gio_ket_thuc, tc.Ngay, tc.status, tc.id
                                    FROM users nv
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger"
                                                            onclick="if (confirm('Bạn có chắc chắn muốn xóa?')) window.location.href='xoa_tang_ca.php?x=<?php echo $row['id'] ?>'"><i
