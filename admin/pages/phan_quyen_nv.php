                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT nv.Ma_nv, nv.username, nv.Gioitinh, nv.chucdanh, nv.Sualichlam, nv.Phophong, nv.email FROM users nv  LEFT JOIN bo_phan bp ON nv.ID_bophan = bp.ID WHERE bp.ID = '$Idbp'";
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" <?php echo $isPhophong; ?>
                                                    onchange="updateRole('<?php echo $row['email']; ?>', 'Phophong', this)">
                                            </td>
                                            <td>
                                                <input type="checkbox" <?php echo $isSualichlam; ?>
                                                    onchange="updateRole('<?php echo $row['email']; ?>', 'Sualichlamnv', this)">
                                            </td>
...
<script>
    function updateRole(username, roleField, checkbox) {
        ...
        xhr.send(JSON.stringify({ username: username, roleField: roleField, roleValue: roleValue }));
    }
</script>
