                            ...
                            <form method="post" action="">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "
                                    SELECT nv.username, cc.Gio_checkin, cc.so_gio_lam, cc.so_gio_thieu, cc.ID_cham_cong, cc.phe_duyet, cc.Gio_checkout, cc.Ngay, cc.role, pcl.ngay, clv.Tenca, clv.Gio_bat_dau, clv.Gio_ket_thuc
                                    FROM users nv
                                ...
                                ";
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="check_list[]"
                                                                value="<?php echo $row['ID_cham_cong']; ?>"></td>
                                        ...
                                        <div class="mb-2">
                                            <button type="submit" name="duyet" class="btn btn-success">Duyệt
                                                công</button>
                                        </div>
                            </form>
                            </tbody>
