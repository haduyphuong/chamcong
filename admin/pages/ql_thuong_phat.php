                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT thuong_phat.*,users.username AS ten_nhan_vien FROM thuong_phat JOIN users ON thuong_phat.Ma_nv = users.Ma_nv WHERE MONTH(Ngay_thuc_hien) = '$month' and YEAR(Ngay_thuc_hien) ='$year'";
