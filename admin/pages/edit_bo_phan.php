        ...
        <div class="container-fluid">
            <div class="card card-primary">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo ($bo_phan['Ten']) ?>" type="text" name='ten' required
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo ($bo_phan['ma_pb']) ?>" type="text" name='ma_pb' required
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo ($bo_phan['ten_bp']) ?>" type="text" name='ten_bp' required
                                        class="form-control">
                                </div>
                            </div>
                            <!-- <div class="col-sm-6">
                ...
                if (isset($_POST['btn'])) {
                    ...
                    $ten_bp = $_POST['ten_bp'];
                    // $pass = $_POST['password'];
                    $sql = "UPDATE bo_phan SET ten_pb = '$ten', ma_pb = '$ma_pb', ten_bp = '$ten_bp' WHERE ID = '$id'";
                    $result = mysqli_query($conn, $sql);
