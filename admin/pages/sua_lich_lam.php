...
$user_id = $_SESSION['id'];
$sqlpb = "SELECT nv.ID_bophan FROM users nv WHERE u.id = $user_id";
...
<div class="content-wrapper">
    ...
    $sql = "SELECT nv.username, DATE(pcl.ngay) AS ngay, clv.Tenca, clv.Gio_bat_dau, clv.Gio_ket_thuc, pcl.id
        FROM users nv
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary"
                                                    onclick="window.location.href='edit_phan_ca_nv.php?ID=<?php echo $row['id'] ?>'"><i
                                                        class="fa fa-edit"></i></button>
                                                <button class="btn btn-danger"
                                                    onclick="if(confirm('Bạn có chắc chắn muốn xóa không?')) window.location.href='xoa_phan_ca.php?xnv=<?php echo $row['id'] ?>'"><i
