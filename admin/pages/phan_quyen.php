                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($row['role'] == '1') { ?>
                                                <td>
                                                    <select
                                                        onchange="updateBoPhan('<?php echo $row['username']; ?>', this.value)">
                                            ...
                                            <?php } ?>
                                            <td>
                                                <input type="checkbox" <?php echo $isAdmin; ?>
                                                    onchange="updateRole('<?php echo $row['username']; ?>', '0', this)">
                                            </td>
                                            <td>
                                                <input type="checkbox" <?php echo $isManager; ?>
                                                    onchange="updateRole('<?php echo $row['username']; ?>', '1', this)">
                                            </td>
                                            <td>
                                                <input type="checkbox" <?php echo $isEmployee; ?>
                                                    onchange="updateRole('<?php echo $row['username']; ?>', '2', this)">
                                            </td>
                                            <td>
                                                <input type="checkbox" <?php echo $approved; ?>
                                                    onchange="updateApproveMessage('<?php echo $row['username']; ?>', '1', this)">
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<script>
    function updateRole(username, role, checkbox) {
        ...
        xhr.send(JSON.stringify({ username: username, role: newRole }));
    }
    ...
    function updateApproveMessage(username, role, checkbox) {
        ...
        xhr.send(JSON.stringify({ username: username, approve_message: newApprove }));
    }
    ...
    function updateBoPhan(username, boPhanId) {
        ...
        xhr.send(JSON.stringify({ username: username, bo_phan_id: boPhanId }));
    }
</script>
