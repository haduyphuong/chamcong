...
<div class="content-wrapper">
    ...
    $sql = "SELECT nv.username, nv.Ma_nv, DATE(pcl.ngay) AS ngay, clv.Tenca, clv.Gio_bat_dau, clv.Gio_ket_thuc, pcl.id
        FROM users nv
...
$dates = range(1, $daysInMonth);
    ...
    if ($result1->num_rows > 0) {
        while ($row1 = $result1->fetch_assoc()) {
            $username = $row1['username']; // Lưu tên nhân viên
            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th class="namenv" rowspan="2" style="vertical-align: middle;background: lightgreen;">Tên/ngày
                        </th>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "
                                    SELECT nv.Ma_nv, nv.username, cb.Gio_bat_dau, cb.Gio_ket_thuc, cb.Ngay_thieu, cb.Ngay_cham_bu, cb.status, cb.id
                                    FROM users nv
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger"
                                                            onclick="if (confirm('Bạn có chắc chắn muốn xóa?')) window.location.href='xoa_ot.php?x=<?php echo $row['id'] ?>'"><i
