                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT ung_luong.*,users.username AS ten_nhan_vien FROM ung_luong JOIN users ON ung_luong.Ma_nv = users.Ma_nv WHERE  MONTH(Ngay_ung) = '$month' and YEAR(Ngay_ung) ='$year';";
