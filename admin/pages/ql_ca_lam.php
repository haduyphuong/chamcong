...
<div class="content-wrapper">
        ...
        <section class="content">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-4">
                                ...
                                $result_weekdays = $conn->query($sql_weekdays);
                                ...
                                // Xử lý dữ liệu
                                $shifts_weekdays = [];
                                if ($result_weekdays && $result_weekdays instanceof mysqli_result) {
                                ...
                                $shifts_sunday = [];
                                if ($result_sunday && $result_sunday instanceof mysqli_result) {
            ...
            <th>12h</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="shift-off"><strong>OFF</strong></td>
                                            <td class="text-center" colspan="2">Nghỉ có phép</td>

                                        </tr>
                                        <tr>
                                            <td class="shift-k"><strong>K</strong></td>
                                            <td class="text-center" colspan="2">Nghỉ không phép</td>
 ...
 <section class="content">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Ca làm việc của phòng ban</h4>
                            </div>
                            <div class="card-body">
                                <?php while ($row = $bo_phan->fetch_assoc()): ?>
                                    <button class="btn btn-primary"
                                        onclick="window.location.href='ca_lam_phongban.php?id=<?= $row['ID'] ?>'">
                                        <?= $row['Ten'] ?>
                                    </button>
                                <?php endwhile; ?>
                            </div>
    ...
    <?php if ($_SESSION['role'] == 1) { ?>
        ...
        $sql = "SELECT nv.username,nv.Ma_nv,nv.Ma_bo,nv.Ma_nhom,nv.chucdanh, DATE(pcl.ngay) AS ngay, clv.Tenca, clv.Gio_bat_dau, clv.Gio_ket_thuc, pcl.id
        FROM users nv
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($shifts as $username => $shiftsData): ?>
                            <tr>
                                <td><?php echo $s += 1; ?></td>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                <button onclick="window.location.href='download_excel.php'" class="btn btn-outline-primary">Tải file Excel mẫu</button>
                                
                            <button onclick="window.location.href='upload_excel.php'" class="btn btn-outline-info">Nhập từ Excel</button>
                            <button onclick="window.location.href='phan_ca_lam.php'" class="btn btn-outline-success">Phân ca làm việc</button>
                            
                            <input type="file" id="uploadExcel" style="display: none;" onchange="uploadExcelFile()">
                        </div>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body table-responsive p-0">
                                <table id="example2" class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        while ($result2 && $result2 instanceof mysqli_result && $row2 = mysqli_fetch_assoc($result2)) {
