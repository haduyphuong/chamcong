                        ...
                        <div class="card-body">
                            <table id="example" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    $result = mysqli_query($conn, "SELECT nghi_viec.*,users.username AS ten_nhan_vien FROM nghi_viec JOIN users ON nghi_viec.Ma_nv = users.Ma_nv;") or die("Câu lệnh truy vấn sai");
