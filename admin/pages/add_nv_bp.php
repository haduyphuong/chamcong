                ...
                <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="calam" id="calam" required class="form-control">
                                        <?php while ($row = $ca_lam_viec->fetch_assoc()) : ?>
                                            <option value="<?php echo $row['ID_calam'] ?>"><?php echo $row['Gio_bat_dau'] . ' đến ' . $row['Gio_ket_thuc'] ?></option>
                                        <?php endwhile ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    if (isset($_POST['btn'])) {
                        ...
                        if ($dem > 0) {
                            ...
                            $sql = "INSERT INTO users VALUES('$ma','$ten','$gt','$ngay','$qq','$sdt','$bophan','$calam','$luong','$ngaylam')";
                            $result = mysqli_query($conn, $sql);
                            if ($result == true) {
