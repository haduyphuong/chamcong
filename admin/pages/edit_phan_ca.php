...
$Idbp = $row1['ID'];
$sqlnv = "SELECT * FROM users WHERE ID_bophan = '$Idbp'";
...
$sql = "SELECT pcl.*, nv.username, clv.ID, clv.Tenca, clv.Gio_bat_dau, clv.Gio_ket_thuc, pcl.ngay
        FROM phan_ca_lam pcl
        JOIN users nv ON pcl.Ma_nv = nv.Ma_nv
            ...
            <div class="card card-primary">
                ...
                <form method="post">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="employee" id="">
                                        <option value="<?php echo $row1['Ma_nv']; ?>"><?php echo ($row1['username']) ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    if (isset($_POST['btn'])) {
                        ...
                        if ($result2 == true) {
                            echo "Sửa Thành Công !Hãy vào <a href='ql_ca_lam.php'>Danh sách </a> để xem lại";
                        } else {
