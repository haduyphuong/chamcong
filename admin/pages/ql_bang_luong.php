                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = " SELECT nhan_luong.*,users.username,luong.Luong_co_ban FROM nhan_luong JOIN users ON nhan_luong.Ma_nv = users.Ma_nv JOIN luong ON nhan_luong.He_so_luong = luong.He_so_luong WHERE MONTH(Thoi_gian) = '$month' and YEAR(Thoi_gian) ='$year'";
